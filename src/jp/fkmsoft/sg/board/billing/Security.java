...
import jp.fkmsoft.sg.board.billing.util.Base64;
import jp.fkmsoft.sg.board.billing.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (BillingLogger.isDebugEnabled()) {
            BillingLogger.info(TAG, "signedData: " + signedData);
        }
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = "<public key is here>";
    ...
    public static boolean verify(PublicKey publicKey, String signedData, String signature) {
        if (BillingLogger.isDebugEnabled()) {
            BillingLogger.info(TAG, "signature: " + signature);
        }
        Signature sig;
        try {
